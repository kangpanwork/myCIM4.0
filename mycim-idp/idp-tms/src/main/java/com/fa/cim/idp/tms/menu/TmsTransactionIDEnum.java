package com.fa.cim.idp.tms.menu;
 ...
 */
public enum TmsTransactionIDEnum {
    NULL(null),
    //----------TMS  Tx Funciton ID------------------------
    ...
    ROM02("ROM02"), // The RtmsTransportJobStopReqController ID
    ROM03("ROM03"), // The RtmsTransportJobPauseReqService ID
    ROM04("ROM04"), // The RtmsTransportJobCancelReqController ID
    ROM05("ROM05"),// The TransportJobResumeReqController ID
    ...
    TmsTransactionIDEnum(String value) {
        this.value = value;
    }
     ...
     * @date 2018/3/20
     */
    public static TmsTransactionIDEnum get(String value) {
        if (value instanceof String) {
            for (TmsTransactionIDEnum transactionIDEnum : TmsTransactionIDEnum.values()) {
     ...
     * @date 2018/3/20
     */
    public static boolean equals(TmsTransactionIDEnum transactionIDEnum, String value) {
        if (value instanceof String) {
