...
import com.fa.cim.service.SeasonPlanEventRecordService;
...
@Slf4j
@Controller
public class SeasonPlanEventRecordTask {

    @Autowired
    private SeasonPlanEventRecordService seasonPlanEventRecordService;
    ...
    public void createSeasonPlanEventRecord() {
        String fifoTableName = "OMEVSEASON_QUE";
        ...
        for (String event : events) {
            try {
                ...
                seasonPlanEventRecordService.createSeasonPlanEventRecord(event);
