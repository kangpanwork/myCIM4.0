...
public class ChamberStatusChangeHistoryService {
     ...
     * @date 2019/7/1 10:38
     */
    public Infos.ChamberStatusChangeEventRecord getEventData(String id) {
        String sql="Select * from OMEVCMBSC where id=?";
        List<Map> sqlDatas = baseCore.queryAllForMap(sql, id);
        Infos.ChamberStatusChangeEventRecord theEventData=new Infos.ChamberStatusChangeEventRecord();
        ...
        for (Map<String,Object> sqlData:sqlDatas) {
            ...
            theEventData.setProcessResourceState(convert(sqlData.get("EQP_STATE_ID")));
            theEventData.setProcessResourceE10State(convert(sqlData.get("E10_STATE_ID")));
            theEventData.setActualProcessResourceState(convert(sqlData.get("ACTUAL_EQP_STATE_ID")));
            theEventData.setActualProcessResourceE10State(convert(sqlData.get("ACTUAL_E10_STATE_ID")));
            theEventData.setStartTimeStamp(convert(sqlData.get("START_TIME")));
            theEventData.setNewProcessResourceState(convert(sqlData.get("NEW_EQP_STATE_ID")));
            theEventData.setNewProcessResourceE10State(convert(sqlData.get("NEW_E10_STATE_ID")));
            theEventData.setNewActualProcessResourceState(convert(sqlData.get("NEW_ACTUAL_EQP_STATE_ID")));
            theEventData.setNewActualProcessResourceE10State(convert(sqlData.get("NEW_ACTUAL_E10_STATE_ID")));
    ...
    public List<Infos.UserDataSet> allUserDataSets(String refKey) {
        String sql="SELECT * FROM OMEVCMBSC_CDA WHERE REFKEY=?";
