...
public class SLMSwitchHistoryService {
     ...
     */
    public Infos.SLMSwitchEventRecord getEventData(String id) {
        String sql="Select * from OMEVFMCSWITCH where id=?";
        List<Map> sqlDatas = baseCore.queryAllForMap(sql, id);
        Infos.SLMSwitchEventRecord theEventData=new Infos.SLMSwitchEventRecord();
        ...
        for (Map<String,Object> sqlData:sqlDatas) {
            ...
            theEventData.setSLMSwitch(convert(sqlData.get("FMC_SWTICH")));
    ...
    public List<Infos.UserDataSet> allUserDataSets(String refKey) {
        String sql="SELECT * FROM OMEVFMCSWITCH_UDATA  WHERE REFKEY=?";
     ...
     * ---------------------------------------------------------------------------------------------------------------------
     *
     * @param fhslmswitchhs_Record
     * @return com.fa.cim.dto.Response
     * @exception
     * @author Ho
     * @date 2019/7/30 9:43
     */
    public Response  insertSLMSwitchHistory_FHSLMSWITCHHS( Infos.Ohslmswitchhs    fhslmswitchhs_Record  ) {
        log.info("HistoryWatchDogServer::InsertSLMSwitchHistory_FHSLMSWITCHHS Function" );

        String hFHSLMSWITCHHSEQP_ID               ="";
        String hFHSLMSWITCHHSSLM_SWITCH           ="";
        String hFHSLMSWITCHHSCLAIM_TIME           ="";
        String hFHSLMSWITCHHSCLAIM_USER_ID        ="";
        String hFHSLMSWITCHHSCLAIM_MEMO           ="";
        String hFHSLMSWITCHHSSTORE_TIME           ="";
        String hFHSLMSWITCHHSEVENT_CREATE_TIME    ="";

        hFHSLMSWITCHHSEQP_ID                 = fhslmswitchhs_Record.getEquipmentID()        ;
        hFHSLMSWITCHHSSLM_SWITCH             = fhslmswitchhs_Record.getSLMSwitch()          ;
        hFHSLMSWITCHHSCLAIM_TIME             = fhslmswitchhs_Record.getClaimTime()          ;
        hFHSLMSWITCHHSCLAIM_USER_ID          = fhslmswitchhs_Record.getClaimUser()          ;
        hFHSLMSWITCHHSCLAIM_MEMO             = fhslmswitchhs_Record.getClaimMemo()          ;
        hFHSLMSWITCHHSSTORE_TIME             = fhslmswitchhs_Record.getStoreTime()          ;
        hFHSLMSWITCHHSEVENT_CREATE_TIME      = fhslmswitchhs_Record.getEventCreateTime()    ;

        baseCore.insert("INSERT INTO OHFMCSWITCH (ID,\n"+
                        "EQP_ID                  ,FMC_SWTICH                 ,TRX_TIME                 ,TRX_USER_ID                  ,TRX_MEMO                 ,STORE_TIME          ,EVENT_CREATE_TIME   )\n"+
                        "Values (?,\n"+
                        "?   ,?  ,?  ,?   ,?  ,CURRENT_TIMESTAMP   ,?    )",generateID(Infos.Ohslmswitchhs.class),
                hFHSLMSWITCHHSEQP_ID,
                hFHSLMSWITCHHSSLM_SWITCH,
                convert(hFHSLMSWITCHHSCLAIM_TIME),
                hFHSLMSWITCHHSCLAIM_USER_ID,
                hFHSLMSWITCHHSCLAIM_MEMO,
                convert(hFHSLMSWITCHHSEVENT_CREATE_TIME));
