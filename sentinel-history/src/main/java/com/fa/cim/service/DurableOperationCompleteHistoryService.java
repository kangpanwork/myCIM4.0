...
public class DurableOperationCompleteHistoryService {
     ...
     * @date 2019/7/1 10:38
     */
    public Infos.DurableOperationCompleteEventRecord getEventData(String id) {
        String sql="Select * from OMEVDURMVO where id=?";
        List<Map> sqlDatas = baseCore.queryAllForMap(sql, id);
        Infos.DurableOperationCompleteEventRecord theEventData=new Infos.DurableOperationCompleteEventRecord();
        ...
        for (Map<String,Object> sqlData:sqlDatas) {
            ...
            sql="SELECT * FROM OMEVDURMVI_RPARAM WHERE REFKEY=?";
    ...
    public List<Infos.UserDataSet> allUserDataSets(String refKey) {
        String sql="SELECT * FROM OMEVDURMVO_CDA WHERE REFKEY=?";
     ...
     * ---------------------------------------------------------------------------------------------------------------------
     *
     * @param fhdrblopehs_rparm_record
     * @return com.fa.cim.dto.Response
     * @exception
     * @author Ho
     * @date 2019/7/11 14:29
     */
    public Response insertDRBLHistory_FHDRBLOPEHS_RPARM( Infos.Ohdrblopehs_rparm fhdrblopehs_rparm_record ) {
        String hFHDRBLOPEHS_RPARM_DURABLE_ID     ;
        String hFHDRBLOPEHS_RPARM_DRBL_CATEGORY  ;
        String hFHDRBLOPEHS_RPARM_MAINPD_ID      ;
        String hFHDRBLOPEHS_RPARM_OPE_NO         ;
        Long hFHDRBLOPEHS_RPARM_OPE_PASS_COUNT;
        String hFHDRBLOPEHS_RPARM_CLAIM_TIME     ;
        String hFHDRBLOPEHS_RPARM_OPE_CATEGORY   ;
        String hFHDRBLOPEHS_RPARM_RPARM_NAME     ;
        String hFHDRBLOPEHS_RPARM_RPARM_VALUE    ;

        hFHDRBLOPEHS_RPARM_DURABLE_ID        ="";
        hFHDRBLOPEHS_RPARM_DRBL_CATEGORY     ="";
        hFHDRBLOPEHS_RPARM_MAINPD_ID         ="";
        hFHDRBLOPEHS_RPARM_OPE_NO            ="";
        hFHDRBLOPEHS_RPARM_CLAIM_TIME        ="";
        hFHDRBLOPEHS_RPARM_OPE_CATEGORY      ="";
        hFHDRBLOPEHS_RPARM_RPARM_NAME        ="";
        hFHDRBLOPEHS_RPARM_RPARM_VALUE       ="";

        hFHDRBLOPEHS_RPARM_DURABLE_ID        = fhdrblopehs_rparm_record.getDurable_id       ();
        hFHDRBLOPEHS_RPARM_DRBL_CATEGORY     = fhdrblopehs_rparm_record.getDrbl_category    ();
        hFHDRBLOPEHS_RPARM_MAINPD_ID         = fhdrblopehs_rparm_record.getMainpd_id        ();
        hFHDRBLOPEHS_RPARM_OPE_NO            = fhdrblopehs_rparm_record.getOpe_no           ();
        hFHDRBLOPEHS_RPARM_OPE_PASS_COUNT = fhdrblopehs_rparm_record.getOpe_pass_count();
        hFHDRBLOPEHS_RPARM_CLAIM_TIME        = fhdrblopehs_rparm_record.getClaim_time       ();
        hFHDRBLOPEHS_RPARM_OPE_CATEGORY      = fhdrblopehs_rparm_record.getOpe_category     ();
        hFHDRBLOPEHS_RPARM_RPARM_NAME        = fhdrblopehs_rparm_record.getRparm_name       ();
        hFHDRBLOPEHS_RPARM_RPARM_VALUE       = fhdrblopehs_rparm_record.getRparm_value      ();

        baseCore.insert("INSERT INTO OHDUROPE_RPARAM\n" +
                "            (ID, DRBL_ID,\n" +
                "                    DRBL_CATEGORY,\n" +
                "                    PROCESS_ID,\n" +
                "                    OPE_NO,\n" +
                ...
                "                    ?,\n" +
                "                    ?,\n" +
                "                    ?)",generateID(Infos.Ohdrblopehs_rparm.class)
                ,hFHDRBLOPEHS_RPARM_DURABLE_ID
                ,hFHDRBLOPEHS_RPARM_DRBL_CATEGORY
                ,hFHDRBLOPEHS_RPARM_MAINPD_ID
                ,hFHDRBLOPEHS_RPARM_OPE_NO
                ,hFHDRBLOPEHS_RPARM_OPE_PASS_COUNT
                ,convert(hFHDRBLOPEHS_RPARM_CLAIM_TIME)
                ,hFHDRBLOPEHS_RPARM_OPE_CATEGORY
                ,hFHDRBLOPEHS_RPARM_RPARM_NAME
                ,hFHDRBLOPEHS_RPARM_RPARM_VALUE );
