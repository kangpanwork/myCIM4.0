...
public class DurableReworkHistoryService {
     ...
     */
    public Infos.DurableReworkEventRecord getEventData(String id) {
        String sql="Select * from OMEVDURRWK where id=?";
        List<Map> sqlDatas = baseCore.queryAllForMap(sql, id);
        Infos.DurableReworkEventRecord theEventData=new Infos.DurableReworkEventRecord();
    ...
    public List<Infos.UserDataSet> allUserDataSets(String refKey) {
        String sql="SELECT * FROM OMEVDURRWK_CDA WHERE REFKEY=?";
