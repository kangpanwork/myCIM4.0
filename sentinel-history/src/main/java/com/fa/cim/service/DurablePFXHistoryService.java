...
public class DurablePFXHistoryService {
     ...
     * @date 2019/7/1 10:38
     */
    public Infos.DurablePFXEventRecord getEventData(String id) {
        String sql="Select * from OMEVDURPRFCX where id=?";
        List<Map> sqlDatas = baseCore.queryAllForMap(sql, id);
        Infos.DurablePFXEventRecord theEventData=new Infos.DurablePFXEventRecord();
    ...
    public List<Infos.UserDataSet> allUserDataSets(String refKey) {
        String sql="SELECT * FROM OMEVDURPRFCX_CDA WHERE REFKEY=?";
