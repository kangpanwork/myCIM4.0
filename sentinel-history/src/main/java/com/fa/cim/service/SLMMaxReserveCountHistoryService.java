...
public class SLMMaxReserveCountHistoryService {
     ...
     */
    public Infos.SLMMaxReserveCountEventRecord getEventData(String id) {
        String sql="Select * from OMEVFMCWRSVLIM where id=?";
        List<Map> sqlDatas = baseCore.queryAllForMap(sql, id);
        Infos.SLMMaxReserveCountEventRecord theEventData=new Infos.SLMMaxReserveCountEventRecord();
        ...
        for (Map<String,Object> sqlData:sqlDatas) {
            theEventData.setMachineID(convert(sqlData.get("EQP_ID")));
            theEventData.setMachineContainerID(convert(sqlData.get("EQPCTNR_ID")));
            theEventData.setMaxReserveCount(convertL(sqlData.get("WAFER_RSV_LIMIT")));
     ...
     * ---------------------------------------------------------------------------------------------------------------------
     *
     * @param fhslmmaxrsvcnths_Record
     * @return com.fa.cim.dto.Response
     * @exception
     * @author Ho
     * @date 2019/7/30 9:52
     */
    public Response  insertSLMMaxReserveCountHistory_FHSLMMAXRSVCNTHS( Infos.Ohslmmaxrsvcnths    fhslmmaxrsvcnths_Record  ) {
        log.info("HistoryWatchDogServer::InsertSLMMaxReserveCountHistory_FHSLMMAXRSVCNTHS Function" );

        String hFHSLMMAXRSVCNTHSEQP_ID               ="";
        String hFHSLMMAXRSVCNTHSEQPCTN_ID            ="";
        String hFHSLMMAXRSVCNTHSCLAIM_TIME           ="";
        String hFHSLMMAXRSVCNTHSCLAIM_USER_ID        ="";
        String hFHSLMMAXRSVCNTHSCLAIM_MEMO           ="";
        String hFHSLMMAXRSVCNTHSSTORE_TIME           ="";
        String hFHSLMMAXRSVCNTHSEVENT_CREATE_TIME    ="";
        Integer hFHSLMMAXRSVCNTHSMAX_RSV_COUNT = 0;

        hFHSLMMAXRSVCNTHSEQP_ID                 = fhslmmaxrsvcnths_Record.getEquipmentID()        ;
        hFHSLMMAXRSVCNTHSEQPCTN_ID              = fhslmmaxrsvcnths_Record.getMachineContainerID() ;
        hFHSLMMAXRSVCNTHSCLAIM_TIME             = fhslmmaxrsvcnths_Record.getClaimTime()          ;
        hFHSLMMAXRSVCNTHSCLAIM_USER_ID          = fhslmmaxrsvcnths_Record.getClaimUser()          ;
        hFHSLMMAXRSVCNTHSCLAIM_MEMO             = fhslmmaxrsvcnths_Record.getClaimMemo()          ;
        hFHSLMMAXRSVCNTHSSTORE_TIME             = fhslmmaxrsvcnths_Record.getStoreTime()          ;
        hFHSLMMAXRSVCNTHSEVENT_CREATE_TIME      = fhslmmaxrsvcnths_Record.getEventCreateTime()    ;
        hFHSLMMAXRSVCNTHSMAX_RSV_COUNT  = fhslmmaxrsvcnths_Record.getMaxReserveCount();

        baseCore.insert("INSERT INTO OHFMCWRSVLIM (ID,\n"+
                        "EQP_ID                  ,EQPCTNR_ID  ,WAFER_RSV_LIMIT  ,TRX_TIME                 ,TRX_USER_ID                  ,TRX_MEMO                 ,STORE_TIME          ,EVENT_CREATE_TIME   )\n"+
                        "Values (?,\n"+
                        "?   ,?  ,?    ,?  ,?   ,?  ,CURRENT_TIMESTAMP   ,?    )",generateID(Infos.Ohslmmaxrsvcnths.class),
                hFHSLMMAXRSVCNTHSEQP_ID,
                hFHSLMMAXRSVCNTHSEQPCTN_ID,
                hFHSLMMAXRSVCNTHSMAX_RSV_COUNT,
                convert(hFHSLMMAXRSVCNTHSCLAIM_TIME),
                hFHSLMMAXRSVCNTHSCLAIM_USER_ID,
                hFHSLMMAXRSVCNTHSCLAIM_MEMO,
                convert(hFHSLMMAXRSVCNTHSEVENT_CREATE_TIME));
