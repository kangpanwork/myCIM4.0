...
public class NonRTServiceLocator extends org.apache.axis.client.Service implements NonRTService {

    public NonRTServiceLocator(){
    }

    public NonRTServiceLocator(org.apache.axis.EngineConfiguration config){
        super(config);
    }

    public NonRTServiceLocator(String wsdlLoc, javax.xml.namespace.QName sName)
                                                                                         throws javax.xml.rpc.ServiceException{
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for Service1Soap
    private String Service1Soap_address = "http://192.168.2.95/NonRTService/NonRTService.asmx";
    ...
    public NonRTServiceSoap getService1Soap() throws javax.xml.rpc.ServiceException {
    ...
    public NonRTServiceSoap getService1Soap(java.net.URL portAddress)
                                                                                                   throws javax.xml.rpc.ServiceException {
        try {
            NonRTServiceSoapStub _stub = new NonRTServiceSoapStub(
                                                                                                                              portAddress,
                                                                                                                              this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (NonRTServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                NonRTServiceSoapStub _stub = new NonRTServiceSoapStub(
                                                                                                                                  new java.net.URL(
                                                                                                                                                   Service1Soap_address),
                                                                                                                                  this);
                _stub.setPortName(getService1SoapWSDDServiceName());
                return _stub;
            }
