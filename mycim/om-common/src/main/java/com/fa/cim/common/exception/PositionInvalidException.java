...
public class PositionInvalidException extends Exception {
    static final long serialVersionUID = -564789466464454L;
    /**
     * description:
     ...
     * @return
     */
    public PositionInvalidException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @return
     */
    public PositionInvalidException(Throwable cause) {
        super(cause);
    }
     ...
     * @return
     */
    protected PositionInvalidException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
