 ...
 */
@Service("EquipmentConfirm")
@Transactional(rollbackFor = Exception.class)
public class EquipmentConfirm implements IEquipmentController {
    @Override
    ...
    @Override
    public Response carrierOutFromIBReq(Params.CarrierOutFromIBReqParam param) {
        return null;
    }
