...
public enum MessageCodeEnum {
    ...
    RC_A_XM(4000),
    RC_AMHS01_NO_RESPONSE(4001),
    RC_AMHS02_NO_RESPONSE(4002),
    ...
    MSG_OK(101),
    MSG_SYSTEM_ERROR(178),
    MSG_INVALID_TYPE(145),
    MSG_ABNORMAL_STOCK(120),
    MSG_MISMATCH_INOUT_LENGTH(156),
    MSG_NEED_SINGLE_DATA(165),
    MSG_MM_CAST_TX_NO_SEND(158),
    MSG_MTSC_UNKNOWN_JOBID(102),
    MSG_UNKNOWN_JOBID(188),
    ;
